# NGUYỄN HUY HÙNG
Thành phố Hồ Chí Minh, Việt Nam | Điện thoại: 0967 622 166 | Email: yisus.nhh.dev@gmail.com
...
- **Yêu cầu & Đặc tả:** Thu thập & Phân tích yêu cầu, Đặc tả Chức năng & Kỹ thuật, User Stories, Use Cases, Process Flows, Data Modeling
- **Ngôn ngữ & Framework:** PHP (Laravel, Lumen), Java (Spring Boot), JavaScript/TypeScript (React, Next.js, Vue.js, Nuxt.js)
- **Cơ sở dữ liệu:** PostgreSQL, MySQL, MongoDB
- **Kiến trúc & Thiết kế:** Domain-Driven Design (DDD), Hexagonal Architecture, Clean Architecture, Modular Monolith, Event-Driven Architecture, EAV Model
- **Bảo mật & Phân quyền:** OAuth2, JWT, Spring Security, Method-level Authorization
- **Công cụ & Nền tảng:** Git, GitHub, GitLab, Docker, Linux, Jira, Maven, PhpStorm, VS Code

---

## KINH NGHIỆM LÀM VIỆC

**Onschool Edtech Group** — Thành phố Hồ Chí Minh, Việt Nam  
**Kỹ sư Kỹ thuật (Technical Engineer)** — *11/2022 – Hiện tại*  
...
**Freelance** — Remote  
**Kỹ sư Kỹ thuật (Technical Engineer)** — *2022 – Hiện tại*  
...
**Đại học Mở Hà Nội** — Hà Nội, Việt Nam  
**Kỹ sư — Công nghệ Phần mềm** — *2019 – 2024*
